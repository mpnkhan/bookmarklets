...
function createResultsWindow(objValidWAIAria) {
	...
	var css=`body,pre{color:#000}a,h1{color:#00427e;background:#fff}a,body,h1{background:#fff}body{margin:0;padding:1em 2em;font-family:helvetica,Verdana,Arial,sans-serif;font-size:1em}h1{font-family:Garamond,"Times New Roman",serif;margin:0 0 0 -.5em;padding:.2em;font-size:3em;border-bottom:6px solid #6c0000}pre{background:#ccc;border:3px double #6c0000;padding:.5em;overflow-x:auto}a:active,a:focus,a:hover{color:#fff;background:#00427e}`;
